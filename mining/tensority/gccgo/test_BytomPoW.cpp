...
int main(void)
{
    ...
    for (int i = 0; i < TEST_NUM; i++) {
        ...
        // matList_int16->copyFrom(*matList_int8);
        matList_int16->init(extSeed);

        iter_mineBytom(g_msg[i], 32, g_nonces[0], results[i]);
...
// g++ -pthread byte_order.c sha3.c  test_BytomPoW.cpp -I /opt/OpenBLAS/include/ -L/opt/OpenBLAS/lib -lopenblas -lpthread
